...
public class SearchCrawler implements Runnable {
	 ...
	 * [url]http://somehost.com/[/url] User-agent: * Disallow: /cgi-bin/
	 * Disallow: /registration # /Disallow robots on registration page Disallow:
	 * /login
	 */
...
//		System.out.println("result:");
		...
		URL url;
		try {
			url = new URL("http://phoenix.apache.org/");
			crawler.downloadPage(url);
